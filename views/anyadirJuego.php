...
require_once dirname(__DIR__) . '/controllers/controladorJuego.php';
...
<main>
    <section class="bg-white rounded shadow-sm p-4 my-4">
        <h2 class="mb-5 text-center">Añadir juego completado</h2>
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        <input type="number" class="form-control text-center pe-none anchoPuntuacionInput" id="puntuacion" name="puntuacion" min="1" max="10" required readonly>
                        <div class="estrellasPuntuacion ms-3" id="rating-stars">
                            <?php for ($i = 1; $i <= 10; $i++): ?>
                                <span class="estrella" data-value="<?php echo $i; ?>">★</span>
                            <?php endfor; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="resenya" name="resenya" rows="4" placeholder="Escribe aquí tu reseña del juego..."></textarea>
                </div>
                
                <div class="row g-3 mb-4 mt-4 text-center align-items-center justify-content-center">
                    <div class="col-12 col-lg-6 mb-3 mb-md-0 d-none" id="caratula-container">
                        <img src="" alt="Vista previa carátula" class="rounded shadow-sm mw-100 h-auto" id="caratula-preview">
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="caratula" class="form-label">Seleccionar carátula:</label>
